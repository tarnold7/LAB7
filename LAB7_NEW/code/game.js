...
function Tele(pos) {
  this.pos = pos.plus(new Vector(9, 37));
  this.size = new Vector(0.8, 1.5);
  this.speed = new Vector(0, 0);
}
Player.prototype.type = "tele";
...
var wobbleSpeed = 5;
var wobbleDist = 0.09;
var teleshakeSpeed = 2;
var teleshakeDis = 0.05;
...
Tele.prototype.act = function(step) {
  this.shake += step * teleshakeSpeed;
  var shakePos = Math.sin(this.shake) * teleshakeDis;
